...
public:
  ...
  oatpp::Object<PageDto<oatpp::Object<UserDto>>> getAllUsersPagination(const oatpp::UInt32 &offset, const oatpp::UInt32 &limit);
  oatpp::Object<StatusDto> deleteUserById(const oatpp::Int32 &id);
  oatpp::Vector<UserDto::Wrapper> getAllUsers();
};
